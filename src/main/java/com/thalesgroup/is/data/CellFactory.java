...
import com.thalesgroup.is.data.model.CsvHeaderCell;
import com.thalesgroup.is.data.model.CsvHeaderRow;
...
public class CellFactory {
	public CsvCell createCell(Boolean hasHeader, Integer columnIndex, Integer rowIndex, String value) {
